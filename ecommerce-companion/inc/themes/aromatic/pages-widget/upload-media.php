...
if( 'Ayroma' == $ecommerce_companion_theme->name){
	$ecommerce_companion_file = ECOMMERCE_COMP_PLUGIN_URL .'inc/themes/ayroma/assets/images/logo.png';
}elseif('Feauty' == $ecommerce_companion_theme->name){
	$ecommerce_companion_file = ECOMMERCE_COMP_PLUGIN_URL .'inc/themes/feauty/assets/images/logo.png';
}else{
	$ecommerce_companion_file = ECOMMERCE_COMP_PLUGIN_URL .'inc/themes/aromatic/assets/images/logo.png';
}	
$ecommerce_companion_PImagePath = ECOMMERCE_COMP_PLUGIN_URL .'inc/themes/storely/assets/images';
...
if (!$ecommerce_companion_upload_file['error']) {
 ...
 update_option( 'aromatic_media_id', $ecommerce_companion_ImageId );
