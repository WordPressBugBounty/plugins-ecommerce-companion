...
if( 'Flow Store' == $ecommerce_companion_theme->name){
	$ecommerce_companion_file = ECOMMERCE_COMP_PLUGIN_URL .'inc/themes/flow-store/assets/images/logo.png';
} else if( 'Flexi Mart' == $ecommerce_companion_theme->name){
	$ecommerce_companion_file = ECOMMERCE_COMP_PLUGIN_URL .'inc/themes/flexi-mart/assets/images/logo.png';
}else{
	$ecommerce_companion_file = ECOMMERCE_COMP_PLUGIN_URL .'inc/themes/flossy/assets/images/logo.png';
}
...
if (!$ecommerce_companion_upload_file['error']) {
 ...
 update_option( 'flossy_media_id', $ecommerce_companion_ImageId );
