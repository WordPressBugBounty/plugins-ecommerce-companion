				...
				<?php
					...
					foreach ($category_cat as $i => $product_cat) {
                        ...
                        <div class="categories-img">                            
                            <img src="<?php echo esc_url($thumbnail_url); ?>" alt="<?php echo esc_attr($category_name->name); ?>" class="w-100 d-block zoom">
                        ...
                        <div class="categories-content">
                            <h4><a href="<?php echo esc_url($category_link); ?>"><?php echo esc_html($category_name->name); ?></a></h4>
                            <p><?php echo esc_html($product_count); ?><?php echo esc_html__(' Products','ecommerce-companion'); ?> </p>
                        </div>
                    </div>
					<?php }
...
if ( function_exists( 'ecommerce_comp_pet_bazaar_category' ) ) {
$ecommerce_companion_section_priority = apply_filters( 'pet_bazaar_section_priority', 12, 'ecommerce_comp_pet_bazaar_category' );
