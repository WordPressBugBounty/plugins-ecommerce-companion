...
require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/electromix-digital/features/electromix-cat-two.php';
...
if ( ! function_exists( 'ecommerce_comp_electromix_frontpage_sections' ) ) :
	function ecommerce_comp_electromix_frontpage_sections() {	
		 ...
		 require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/electromix-digital/sections/section-info.php';
		 require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/electromix/sections/section-category-one.php';
		 require ECOMMERCE_COMP_PLUGIN_DIR . 'inc/themes/electromix-digital/sections/section-banner.php';
