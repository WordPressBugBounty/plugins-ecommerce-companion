...
if( 'Express Store' == $ecommerce_companion_theme->name){
	$ecommerce_companion_file = ECOMMERCE_COMP_PLUGIN_URL .'inc/themes/express-store/assets/images/logo.png';
}elseif('Storefit' == $ecommerce_companion_theme->name){
	$ecommerce_companion_file = ECOMMERCE_COMP_PLUGIN_URL .'inc/themes/storefit/assets/images/logo.png';
}else{
	$ecommerce_companion_file = ECOMMERCE_COMP_PLUGIN_URL .'inc/themes/retailsy/assets/images/logo.png';	
}
...
if (!$ecommerce_companion_upload_file['error']) {
 ...
 update_option( 'retailsy_media_id', $ecommerce_companion_ImageId );
